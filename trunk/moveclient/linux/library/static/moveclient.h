...
int movemeUpdateFrequency(uint32_t);
int movemeUpdateCameraFrequency(uint32_t);
int movemeRumble(uint32_t, uint32_t);
int movemeForceRGB(uint32_t, float, float, float);
