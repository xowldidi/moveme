...
INT WINAPI UpdateMoveState(LPMoveStateDeferred);
...
__declspec(dllexport) INT __cdecl Connect(PCSTR, PCSTR, LPMoveStateDeferred);
__declspec(dllexport) INT __cdecl Disconnect(void);
...
__declspec(dllexport) INT __cdecl UpdateFrequency(uint32_t);
__declspec(dllexport) INT __cdecl CameraUpdateFrequency(uint32_t);
__declspec(dllexport) INT __cdecl Rumble(uint32_t, uint32_t);
__declspec(dllexport) INT __cdecl ForceRGB(uint32_t, float, float, float);
__declspec(dllexport) INT __cdecl TrackHues(uint32_t, uint32_t, uint32_t, uint32_t);
__declspec(dllexport) INT __cdecl PrepareCamera(uint32_t, float);
__declspec(dllexport) INT __cdecl CameraSetNumSlices(uint32_t);
